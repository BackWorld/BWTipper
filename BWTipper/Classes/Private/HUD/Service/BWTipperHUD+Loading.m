                       ...
                       timeout: (NSTimeInterval)timeout
{
    ...
    [self showWithImages:BWTipperConfigure.defaultConfigure.defaultLoadingIcons duration:1.5  delay:timeout message:message backgroundDimmed:backgroundDimmed wrapperDisplayOn:YES completion:nil];
}
